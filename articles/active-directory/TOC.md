...
## [Provide remote access for on-premises apps](active-directory-application-proxy-get-started.md)
...
### [Roles](active-directory-privileged-identity-management-roles.md)
...
### [Create custom roles](role-based-access-control-custom-roles.md)
